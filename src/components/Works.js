          ...
          <Col id="my-works-right" sm={12} md={12} lg={7}>
            ...
            <Row className="body-text">
              <p>
                ...
                project! My main goal was to create an engaging weather app that
                displays real-time information to users. To achieve this, I
                utilized the Open Weather API and the Locations IQ API, ensuring
                secure and authenticated requests by adhering to the API
                documentation and utilizing API keys.
              </p>

              <p>
                Despite encountering challenges with CSS styling and adapting
                the code to handle the startup delay of the backend, I conducted
                thorough usability and manual testing throughout development.
                This allowed me to address challenges and ensure a smoother user
              ...
              <p>
                ...
                works and will be available soon. Overall, I am confident in the
                success of my project and look forward to its continued growth
                and development.
              </p>
            </Row>
            <Row className="technologies-header-text">
