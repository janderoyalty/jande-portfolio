							...
							<Row className="my-works-right--container">
								...
								<Row className="body-text">
									<p>
										...
										their world, products, and updates. Visitors can sign up for
										a newsletter and browse past event photos. As the sole
									...
									<p>
										...
										implementing a login system for easy database updates
										without direct Firebase access.
									</p>
								</Row>
